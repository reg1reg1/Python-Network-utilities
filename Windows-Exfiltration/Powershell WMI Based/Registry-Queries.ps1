...
Invoke-WmiMethod -Namespace root\default -Class StdRegProv -Name GetStringValue @(2147483650,"software\microsoft\internet explorer\typedurls","url1")
...
Invoke-WmiMethod -Namespace root\default -Class StdRegProv -Name EnumValue @(2147483649,"Software\Microsoft\Windows\CurrentVersion\Explorer\RunMRU")
